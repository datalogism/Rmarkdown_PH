...
<div id="rightt"> 
<p style="margin-top:70px;font-size:90%;">Nombreux formats,<br>**multiples usages**</p> 
...
<br>
<p style="margin-top:0px;margin-bottom:30px;font-size:100%;">**Diapositives libres** (CC BY-SA 4.0)</p>
<p style="margin-top:20px;margin-bottom:0px;font-size:65%;">Slides : https://huguespecout.github.io/notebook_mateshs/#/</p>
<p style="margin-top:10pxmargin-bottom:0px;font-size:65%;">Code source : https://github.com/HuguesPecout/notebook_mateshs</p>


<br>
<p style="margin-top:20px;margin-bottom:15px;font-size:100%;">**Contact**</p>
<p style="margin-top:20px;margin-bottom:0px;font-size:70%;">hugues.pecout@cnrs.fr</p>
<p style="margin-top:10px;margin-bottom:0px;font-size:70%;">timothee.giraud@cnrs.fr</p>
<p style="margin-top:10px;margin-bottom:0px;font-size:70%;">sebastien.rey-coyrehourcq@univ-rouen.fr (GT Notebook)</p>
