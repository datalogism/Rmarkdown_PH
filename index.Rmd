...
=> Suivi des modifications (commit, branches, etc.)   
...
quarto + R + Observable + Git

https://rcarto.github.io/Quarto/
...
Le notebook, un format de publication scientifique légitime  

>* [Rzine](rzine.fr), diffusion de ressources R en SHS   
...
Des formats de sortie multiples, nombreux usages :  

<ul class="pucsmall2" style="margin-top:0px;font-size:50%;">
> - <span style="color:grey;">*Support de cours*</span>
> - <span style="color:grey;">*Diaporama*</span>
> - <span style="color:grey;">*Livre*</span>
> - <span style="color:grey;">*Exercice*</span>
> - <span style="color:grey;">*Tutoriel*</span>
> - <span style="color:grey;">*Annexe d'article*</span>
> - <span style="color:grey;">*Blog*</span>
> - <span style="color:grey;">*CV*</span>
> - <span style="color:grey;">*Site web*</span>
...
library(leaflet)
mamap <- leaflet(Here, width = 512, height = 512) %>%
  addTiles() %>%
  addMarkers(data = Here, popup = "❤️❤️mate-shs❤️❤️")
```

## 
```{r, echo=FALSE, out.width="512px"}
mamap
```
