...
## Le petit dernier... <img src="figure/quarto.png" width="230" style="margin-top:0px;margin-bottom:-10px;"/> 


<img src="figure/quarto2.png" style="margin-top:20px;" width="800"/>

<p class="smallpcenter">Fonctionne avec **R**, **Python**, **Julia**, **Javascript** (**OJS**)...</p>
...
<img src="figure/quarto.png" width="280" style="margin-top:0px;margin-bottom:-10px;margin-right:20px;"/> **+** <img src="figure/R.png" width="110" style="margin-top:0px;margin-bottom:-10px;margin-right:20px;margin-left:20px;"/> **+** <img src="figure/javascript.png" width="80" style="margin-top:0px;margin-bottom:-10px;margin-right:20px;margin-left:20px;"/> **+** <img src="figure/git.png" width="150" style="margin-top:0px;margin-bottom:-10px;margin-left:20px;"/> 

<br>
<br>

<p style="font-size:115%;">[Cliquez-moi !](https://rcarto.github.io/Quarto/)</p>
